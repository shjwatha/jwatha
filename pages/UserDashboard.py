...
def get_input_type(field):
    ...
    # البنود المطلوب احتسابها بنعم = 2 نقطة
    elif field in ["سنة الوتر", "سنة الضحى", "درس - قراءة ( شرعي )", "تلاوة قرآن (لا يقل عن ثمن)"]:
        return "yes_no_2"
    else:
        return "yes_no"
...
# الخيارات الخاصة بنظام نعم/لا الافتراضي (نعم = 1 نقطة)
yes_no_options = ["نعم = 1 نقطة", "لا = 0 نقطة"]
yes_no_scores = {"نعم = 1 نقطة": 1, "لا = 0 نقطة": 0}

# الخيارات الخاصة للبنود التي تُسجل نعم بمقدار 2 نقطة
yes_no_2_options = ["نعم = 2 نقطة", "لا = 0 نقطة"]
yes_no_2_scores = {"نعم = 2 نقطة": 2, "لا = 0 نقطة": 0}
